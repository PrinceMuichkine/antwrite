...
function getSelectedImageAlign(selection?: {
  from: number;
  to: number;
}): string {
  const view = getActiveEditorView();
  ...
  return (
    ...
    >
      ...
      <ContextMenuContent className="w-56">
        ...
        <ContextMenuItem
          onSelect={() =>
            handleClipboardCommand(() => document.execCommand('selectAll'))
          }
        ...
        {showImageAlignment && (
          <>
            ...
            <ContextMenuItem
              ...
              onMouseDown={(e) => e.preventDefault()}
              className={
                getSelectedImageAlign(selection) === 'left' ? 'bg-accent' : ''
              }
            >
            ...
            <ContextMenuItem
              ...
              onMouseDown={(e) => e.preventDefault()}
              className={
                getSelectedImageAlign(selection) === 'center' ? 'bg-accent' : ''
              }
            >
            ...
            <ContextMenuItem
              ...
              onMouseDown={(e) => e.preventDefault()}
              className={
                getSelectedImageAlign(selection) === 'right' ? 'bg-accent' : ''
              }
            >
        ...
        <ContextMenuItem
          onSelect={() =>
            handleFormatCommand(() => console.log('Align center'))
          }
          onMouseDown={(e) => e.preventDefault()}
        >
          <AlignCenter className="mr-2 size-4" />
